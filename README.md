...
This branch reflects the nominations-era workflow. The old sponsorship-style approach has been replaced by peer nomination, admin review, and invite approval.
...
Longer-term the plan is to rewrite the app into React + TypeScript, which will make it much faster and able to accommodate much more, with a component-based development style similar to the other React-based applications on Qortal (`Q-Tube`, `Q-Blog`, `Q-Mail`, and so on).
